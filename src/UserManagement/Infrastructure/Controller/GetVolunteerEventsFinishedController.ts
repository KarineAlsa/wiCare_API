...
import GetVolunteerEventsComing from "../../Application/UseCase/GetVolunteerEventsFinishedUseCase";
    ...
    async run(request:Request,response:Response) {
        ...
        try {
            ...
            if (!user){
                ...
                let events = await sendMessageAndWaitForResponse('getEventsFinishedVolunteer',{ volunteerId: id_volunteer });
